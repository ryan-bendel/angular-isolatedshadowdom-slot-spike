...
(function(ErrorCode2) {
  ...
  ErrorCode2[ErrorCode2["ISOLATED_SHADOW_DOM_INVALID_CONTENT_PROJECTION"] = 2027] = "ISOLATED_SHADOW_DOM_INVALID_CONTENT_PROJECTION";
...
var ComponentDecoratorHandler = class {
  ...
  analyze(node, decorator) {
    ...
    if (encapsulation === ViewEncapsulation2.IsolatedShadowDom) {
