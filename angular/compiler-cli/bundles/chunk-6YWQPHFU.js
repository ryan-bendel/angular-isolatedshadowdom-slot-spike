...
(function(ErrorCode2) {
  ...
  ErrorCode2[ErrorCode2["ISOLATED_SHADOW_DOM_INVALID_CONTENT_PROJECTION"] = 2028] = "ISOLATED_SHADOW_DOM_INVALID_CONTENT_PROJECTION";
...
import { compileClassDebugInfo, compileHmrInitializer, compileComponentClassMetadata, compileComponentDeclareClassMetadata, compileComponentFromMetadata, compileDeclareComponentFromMetadata, compileDeferResolverFunction, ConstantPool as ConstantPool2, CssSelector as CssSelector5, DomElementSchemaRegistry as DomElementSchemaRegistry3, ExternalExpr as ExternalExpr10, FactoryTarget as FactoryTarget3, makeBindingParser as makeBindingParser3, outputAst as o5, R3TargetBinder as R3TargetBinder2, R3TemplateDependencyKind, SelectorMatcher as SelectorMatcher3, TmplAstContent as TmplAstContent2, ViewEncapsulation as ViewEncapsulation2, SelectorlessMatcher as SelectorlessMatcher2 } from "@angular/compiler";
...
var ComponentDecoratorHandler = class {
  ...
  analyze(node, decorator) {
    ...
    if (encapsulation === ViewEncapsulation2.ExperimentalIsolatedShadowDom) {
...
function findContentNode(nodes) {
  for (const node of nodes) {
    if (node instanceof TmplAstContent2) {
      return node;
    }
