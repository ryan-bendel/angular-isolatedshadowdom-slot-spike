...
declare class DomRendererFactory2 implements RendererFactory2, OnDestroy {
    ...
    constructor(eventManager: EventManager, sharedStylesHost: SharedStylesHost, appId: string, removeStylesOnCompDestroy: boolean, doc: Document, platformId: Object, ngZone: NgZone, nonce: string | null | undefined, tracingService: (_TracingService<_TracingSnapshot> | null) | undefined, styleScopeService: IsolatedStyleScopeService);
