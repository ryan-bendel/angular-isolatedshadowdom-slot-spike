...
export { EventManager, REMOVE_STYLES_ON_COMPONENT_DESTROY, DomEventsPlugin as ɵDomEventsPlugin, DomRendererFactory2 as ɵDomRendererFactory2, SharedStylesHost as ɵSharedStylesHost, IsolatedStyleScopeService as ɵStyleScopeService } from './_dom_renderer-chunk.mjs';
...
const VERSION = /* @__PURE__ */new Version('21.1.0-next.0+sha-60acf6d-with-local-changes');
